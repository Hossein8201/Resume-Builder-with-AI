from PyQt5.QtWidgets import QWidget, QVBoxLayout, QFormLayout, QLineEdit, QLabel, QPushButton, QHBoxLayout, QSpacerItem, QSizePolicy
    ...
    def initUI(self):
        ...
        for module in modules:
            ...
            if module == "Personal Information":
                label.setStyleSheet("font-weight: bold; font-size: 20px; color: blue; border: 1px solid #d3d3d3; padding: 5px; background-color: #f0f0f0; border-radius: 10px;")
                flag = 1
            elif flag == 1:
                label.setStyleSheet("font-size: 18px; margin-bottom: 10px; color: gray;") 
            else:
                label.setStyleSheet("font-size: 18px; margin-bottom: 10px; color: back;") 
        ...
        left_layout_widget.setFixedSize(350, 800)
